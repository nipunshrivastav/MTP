...
#####################################
    ...
    for imagePath, faces in imageFaces.iteritems():
        ...
        if(imagePath=='/misc/buffer/Softwares/MachineLearning_Data/Object Detector/Face Detection/aflw/data/flickr/3/image00204.jpg'):
            break
        #imagePath = '/misc/buffer/Softwares/MachineLearning_Data/Object Detector/Face Detection/aflw/data/flickr/3/image00188.jpg'
        #faces = imageFaces[imagePath]
        print(imagePath)
        print(faces)
        try:
